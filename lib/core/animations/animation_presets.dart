...
class GlamAnimations {
  ...
  static Widget applyEntryEffect(Widget widget, {
    Duration? duration,
  ...
  static Widget applyButtonPressEffect(Widget widget, {bool isPressed = false}) {
    return widget.animate(target: isPressed ? 1 : 0)
      .custom(
  ...
  static Widget applyShimmerEffect(Widget widget, {
    Duration? duration,
    Color? color,
  }) {
    return widget.animate()
      .shimmer(
        ...
        color: color ?? kAccentColor.withOpacity(0.5),
...
extension GlamAnimateExtension on Widget {
  ...
  Widget glamButton({bool isPressed = false}) {
    return animate(target: isPressed ? 1.0 : 0.0)
      .custom(
